...
public class OrderDetails extends AppCompatActivity implements View.OnClickListener{
    ...
    private int productIndex;//判断当前上架商品
    private int index;//判断是采购上架还是调拨上架
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(index==0){
            ...
            String url2 = HttpApi.Ip+HttpApi.requestHead+HttpApi.getonshelflistbyorderno+order+HttpApi.baseWarehouseCode+HttpApi.code;
            HttpUtils.httpGET(url2,handler);
        }*/
